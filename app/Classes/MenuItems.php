...
//                            4 => array('id' => '030104', 'name' => 'Manage Roles', 'micon' => 'img/newUser.png', 'icon' => '', 'url' => '/user/manageroles', 'slug' => 'manageRoles', 'uiSrefActive' => 'active', 'total_submenu' => 1),
            ...
            //             )),
            //     )),
            6 => array('name' => 'Task Management', 'icon' => 'resp-img menu-icon-sz', 'ui-sref-active' => '', 'url' => '', 'slug' => 'response', 'has_submenu' => true, 'total_submenu' => 2,
            'submenu_ids' => '0601,0602', 'anchorClass' => 'menu-dropdown', 'submenuClass' => 'submenu', 'liClass' => 'open', 'submenu' => array(
                1 => array('id' => '0601', 'name' => 'Task List', 'icon' => '', 'url' => '/TaskManagement', 'slug' => 'tasklistIndex', 'uiSrefActive' => 'active', 'total_submenu' => 1),
                2 => array('id' => '0602', 'name' => 'My Tasks', 'icon' => '', 'url' => '/TaskManagement/mytasklist', 'slug' => 'mytasklist', 'uiSrefActive' => 'active', 'total_submenu' => 1),                
            )),
