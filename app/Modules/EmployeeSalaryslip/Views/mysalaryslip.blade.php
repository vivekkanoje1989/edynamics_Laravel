...
<div class="col-xs-12 col-md-12" ng-controller="employeeSalaryslipController" ng-init="getMySalaryslips(); vbreadcumbs = [
            {'displayName': 'Home', 'url': 'goDashboard()'},
            {'displayName': 'Dashboard', 'url': 'goDashboard()'},            
            {'displayName': 'My Salary slip', 'url': 'goListemployee()'}
        ];">
	...
	<div class="widget">
		...
		<div class="widget-body">
			...
			<div class="DTTTFooter">
                <div class="col-sm-6">
                	<div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite" >Showing page {{noOfRows}} of {{ myslrslips.length }} entries </div>
        ...
        <div class="modal-dialog">           
            <div class="modal-content" style="border: 3px solid azure;border-radius: 30px;height: 489px; background: #0e0e0e38;overflow: auto;">
                <div class="modal-header modal-header widget-header bordered-bottom bordered-themeprimary" style="border-radius: 27px; margin-top: 25px; width: 90%;margin-left: 20px;margin-right: 20px;">
                    ...
                    <h4 class="modal-title" align="center">My Salary Slip Help Info</h4>
                </div>                
                <div class="modal-body" style="">
                    <div class="form-group ">
						...
						<div class="form-group col-sm-9">
							<p style="font-family: serif;font-size: 17px;">My Salary Slip here individual Salary slip can be found and download.<p>
                        </div>				
                    </div> 
					<div class="form-group ">
						<div class="form-group col-sm-3">
