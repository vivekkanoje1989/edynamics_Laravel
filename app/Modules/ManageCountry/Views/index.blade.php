    ...
    <div class="modal fade" id="countryModal" role="dialog" tabindex="-1">    
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form novalidate ng-submit="countryForm.$valid && doCountryAction()" name="countryForm">
                    <div class="modal-body">
                        <div class="form-group" ng-class="{ 'has-error' : sbtBtn && (!countryForm.name.$dirty && countryForm.name.$invalid) && (!countryForm.phonecode.$dirty && countryForm.phonecode.$invalid) && (!countryForm.sortname.$dirty && countryForm.sortname.$invalid)}">
                            <input type="hidden" class="form-control" ng-model="id" name="id">
                            <span class="input-icon icon-right">
                                <input type="text" class="form-control" ng-model="name" name="name" placeholder="Country" ng-change="errorMsg = null" required>
                            ...
                            <span class="input-icon icon-right">
                                <input type="number" class="form-control" ng-model="phonecode" name="phonecode" placeholder="Phonecode"  required>
                                <i class="fa fa-user thm-color circular"></i>
                            ...
                            <span class="input-icon icon-right">
                                <input type="text" class="form-control" ng-model="sortname" name="sortname" placeholder="Sortname"  required>
                                <i class="fa fa-user thm-color circular"></i>
