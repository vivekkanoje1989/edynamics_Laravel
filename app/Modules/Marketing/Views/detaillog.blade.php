<div class="row" ng-controller="logdetailController" ng-init="logdetail('[[$tranid]]','[[$empid]]');managedetailLogs('0',1,[[config('global.recordsPerPage')]]);">

    <div class="col-xs-12 col-md-12">
        <div class="widget">
            <div class="widget-header ">
                <span class="widget-caption">Sms Logs details</span>
            </div>
            <div class="widget-body table-responsive">
             <div class="row">    
                    <div class="col-sm-6 col-xs-12" style="float:left"> 
                    <div class="col-sm-3 center">
                        <input type="text" minlength="1" maxlength="3"  ng-model="itemsPerPage" ng-change="logdetail('[[$tranid]]','[[$empid]]');managedetailLogs('0',{{pageNumber}}, itemsPerPage);" ng-model-options="{ updateOn: 'blur' }" oninput="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  class="form-control">
                    </div>
                    <div class="col-sm-3 center">
                        <button type="button" class="btn btn-primary ng-click-active"  data-toggle="modal" data-target="#showFilterModal" ng-click="procName('proc_smslogdetail', '0')">
                    ...
                    <div class="col-sm-6 col-xs-12 dataTables_paginate paging_bootstrap" id="DataTables_Table_0_paginat">                         
                        <span ng-if="smslogslength != 0" >&nbsp; &nbsp; &nbsp; Showing {{smslogslistdetail.length}}  Logs Out Of Total {{smslogslength}} Logs.  &nbsp;</span>
                        <dir-pagination-controls max-size="5"  class="pull-right pagination" on-page-change="pageChanged(newPageNumber,0,'managedetailLogs',itemsPerPage)" template-url="/dirPagination" ng-if="smslogslength"></dir-pagination-controls>                        
                    </div>
                ...
                <table class="table table-hover table-striped table-bordered" at-config="config">
                    <thead class="bord-bot">
                        <tr>
                            ...
                            <th style="width:8%">Credit Deducted</th>
                    ...
                    <tbody>
                        ...
                        <tr role="row" dir-paginate="listSms in smslogslistdetail | filter:search | itemsPerPage:itemsPerPage" total-items="{{ smslogslength}}">
                           ...
                           <td ng-if="<?php echo Auth::guard('admin')->user()->customer_contact_numbers == 1?> "> {{ listSms.mobile_number}} </td> 
                            ...
                            <td>{{listSms.credits_deducted}}</td>
                        ...
                        <tr>
                           <td colspan="11"  ng-show="(smslogslistdetail|filter:search).length == 0" align="center">Record Not Found</td>   
                        </tr>
                    </tbody>
                </table><br>
       ...
       <div data-ng-include="'/Marketing/showDetailFilter'"></div>
    </div>
