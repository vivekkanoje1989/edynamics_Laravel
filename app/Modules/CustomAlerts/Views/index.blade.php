...
<div class="row" ng-controller="customalertsController" ng-init="manageAlerts('','index')">
        ...
        <div class="widget">
            ...
            <div class="widget-body table-responsive">
                ...
                <table class="table table-hover table-striped table-bordered" at-config="config">
                    ...
                    <tbody>
                        <tr role="row" dir-paginate="listAlert in listcustomAlerts | filter:search | itemsPerPage:itemsPerPage | orderBy:orderByField:reverseSort">
                ...
                <div class="DTTTFooter">
                    <div class="col-sm-6">
                        <!--<div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite">Showing {{itemsPerPage * (noOfRows-1)+1}} to of {{ listcustomAlertsLength }} entries</div>-->
