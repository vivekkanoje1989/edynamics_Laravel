            ...
            <div class="widget-body table-responsive">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12 dataTables_paginate paging_bootstrap" id="DataTables_Table_0_paginate">
                         <span ng-if="inboundLength != 0 " >&nbsp; &nbsp; &nbsp; Showing {{inboundList.length}} Logs Out Of Total {{inboundLength}} Logs&nbsp;</span>
               ...
               <!-- filter data-->
                ...
                <table class="table table-hover table-striped table-bordered" at-config="config">
                    ...
                    <tbody>
                        ...
                        <tr>
                                <td colspan="8"  ng-show="(inboundList|filter:search).length==0" align="center">Record Not Found</td>   
                        </tr>
                    </tbody>
                </table><br>
