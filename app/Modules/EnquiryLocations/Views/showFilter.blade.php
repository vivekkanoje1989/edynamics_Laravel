                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <span class="input-icon icon-right">
                                            <input type="text" ng-model="filterData.city_name" name="city_name" class="form-control" >
                                        </span>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <span class="input-icon icon-right">
                                            <input type="text" ng-model="filterData.location" name="location" class="form-control">
                                        </span>
                                    </div>
