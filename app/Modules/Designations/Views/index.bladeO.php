...
<div class="row" ng-controller="designationsCtrl" ng-init="manageDesignations()">  
                    ...
                    <tbody>
                        <tr role="row" dir-paginate="list in designationsRow  | filter:search |filter:searchData |orderBy:orderByField:reverseSort|itemsPerPage:itemsPerPage" >
                            ...
                            <td class="fa-div">
                                ...
                                <div class="fa-hover" tooltip-html-unsafe="Delete designation" style="display: block;" data-toggle="modal" data-target="#designationsD"><a href="javascript:void(0);" ng-click="initialModal({{ list.id}},'{{list.designation}}','{{list.status}}',{{itemsPerPage}},{{$index}})"><i class="fa fa-trash-o"></i></a></div>
                            </td> 
                        </tr>
                    </tbody>
                </table>
    ...
    <!-- Modal Delete -->
    <div class="modal fade" id="designationsD" role="dialog" tabindex="-1">    
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" align="center">Delete Designation</h4>
                </div>
                <form novalidate ng-submit="designationsForm.$valid && dodesignationsDelete()" name="designationsForm">
                    <input type="hidden" ng-model="csrfToken" name="csrftoken" id="csrftoken" ng-init="csrfToken = '<?php echo csrf_token(); ?>'" class="form-control">
                    ...
                    <div class="modal-footer" align="center">
                        <button type="Submit" class="btn btn-primary" ng-click="sbtBtn = true" ng-disabled="desig_btn">Confirm</button>
                        <button type="button" class="btn btn-primary" ng-click="Cancel()" ng-disabled="desig_btn">Cancel</button>
                    </div> 
                </form>           
            </div>
        </div>
