...
<div class="row" ng-controller="citiesCtrl" ng-init="manageCities(); manageCountry();">  
                    ...
                    <tbody>
                        <tr role="row" dir-paginate="list in citiesRow| filter:search | filter:searchData | itemsPerPage:itemsPerPage | orderBy:orderByField:reverseSort">
                            ...
                            <td class="fa-div">
                                ...
                                <div class="fa-hover" tooltip-html-unsafe="Delete City" style="display: block;" data-toggle="modal" data-target="#cityModalD"><a href="javascript:void(0);" ng-click="initialModal(1,{{list.id}},{{list}},{{ itemsPerPage}},{{$index}})"><i class="fa fa-trash-o"></i></a></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <!-- Modal Delete-->
    <div class="modal fade" id="cityModalD" role="dialog" tabindex="-1">    
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" align="center">Delete City</h4>
                </div>
                <form novalidate ng-submit="citiesForm.$valid && doCitiesDelete()" name="citiesForm">
                    <input type="hidden" ng-model="csrfToken" name="csrftoken" id="csrftoken" ng-init="csrfToken = '<?php echo csrf_token(); ?>'" class="form-control">
