            ...
            <div class="widget-body table-responsive">  
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12">
                      ...
                      <input type="text" type="text" oninput="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"   minlength="1" maxlength="3" style="width:25%;" class="form-control" ng-model="itemsPerPage">
                    </div>
                </div><br>
                ...
                <table class="table table-hover table-striped table-bordered" at-config="config">
                    ...
                    <tbody>
                        <tr role="row" dir-paginate="list in clientInfoList| filter:search |itemsPerPage:itemsPerPage| orderBy:orderByField:reverseSort">
                            ...
                            <td>{{ list.website}}</td> 
                            <td class="fa-div">
                                <div class="fa-hover" tooltip-html-unsafe="Edit" style="display: block;" data-toggle="modal" data-target="#clientGroupsModal"><a href="[[ config('global.backendUrl') ]]#/clients/update/{{ list.id }}"><i class="fa fa-pencil"></i></a></div>
                                <!--<div class="fa-hover" tooltip-html-unsafe="Services" style="display: block;"><a href="#/clientsservices/update/{{ list.id }}" target="_blank"><i class="fa fa-cog"></i></a></div>-->
                                <div class="fa-hover" tooltip-html-unsafe="Accounting" style="display: block;"><a href="[[ config('global.backendUrl') ]]#/clients/clientinfo/{{ list.id }}" target="_blank"><i class="fa fa-user"></i></a></div>
                            </td>
                        </tr>
                        <tr ng-if='totalrecords == 0'>
                            <td colspan='7' ng-show="(clientInfoList|filter:search).length==0" align='center'>No Records Found</td>
                        </tr>
                    </tbody>
                </table>
