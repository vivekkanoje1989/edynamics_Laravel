            ...
            <div class="widget-body table-responsive">     
                <form novalidate ng-submit="testimonialsForm.$valid && doTestimonialsAction(photo_url)" name="testimonialsForm"  enctype="multipart/form-data" ng-init="getTestimonialData('<?php echo $testimonialId; ?>')">
                    ...
                    <table class="table table-hover table-striped table-bordered" at-config="config">
                        ...
                        <tr><td>Mobile No. <span class="sp-err">*</span></td>
                            <td>
                                <div class="form-group" ng-class="{ 'has-error' : sbtBtn && (!testimonialsForm.mobile_number.$dirty && testimonialsForm.mobile_number.$invalid) }">
                                    <span class="input-icon icon-right">
                                        <input type="text" class="form-control" ng-model="mobile_number" name="mobile_number" ng-maxlength="10" ng-minlength="10" required>
                        ...
                        <tr><td>Is Approve <span class="sp-err">*</span></td>
                            <td>
                                <div class="form-group" ng-class="{ 'has-error' : sbtBtn && (!testimonialsForm.approve_status.$dirty && testimonialsForm.approve_status.$invalid) }">
                                    <span class="input-icon icon-right">
                                        <select name="status" ng-model="approve_status" name="approve_status" class="form-control" style="width:30%;">
                        ...
                        <tr><td>Display on Portal <span class="sp-err">*</span></td>
                            <td>
                                <div class="form-group" ng-class="{ 'has-error' : sbtBtn && (!testimonialsForm.web_status.$dirty && testimonialsForm.web_status.$invalid) }">
                                    <span class="input-icon icon-right">
                                        <select name="web_status" ng-model="web_status" name="web_status" class="form-control" style="width:30%;">
                                            <option value="">Please select status</option> 
