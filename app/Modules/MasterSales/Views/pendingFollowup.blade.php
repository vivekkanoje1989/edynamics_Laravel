            ...
            <div class="widget-body table-responsive">
                <div class="row">                   
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="col-sm-3 center">
                            <button type="button" class="btn btn-primary ng-click-active"  data-toggle="modal" data-target="#showFilterModal" ng-click="procName('proc_get_pending_followups')">
                                <i class="btn-label fa fa-filter"></i>Show Filter</button>                            
                        </div>
                        <div  ng-if="enquiriesLength != 0 " class="col-sm-3 center">
                            <a href="" class="btn btn-primary" id="downloadExcel" download="{{fileUrl}}" style="float: right;" ng-show="dnExcelSheet">
                 ...
                 <table class="table table-hover table-striped table-bordered" ng-if="enquiriesLength">
                    <thead>                        
                        <tr>
                            ...
                            <th class="enq-table-th">Pending</th>
            ...
            <div class="modal fade" id="todayremarkDataModal" role="dialog" tabindex='-1'>
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <!--<div data-ng-include=" '/MasterSales/todayremarks'"></div>-->
                        <div class="modal-footer" align="center">
                        </div>
                    </div>
                </div>
