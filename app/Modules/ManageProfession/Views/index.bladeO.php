...
<div class="row" ng-controller="manageProfessionCtrl" ng-init="manageProfession()">  
                ...
                <table class="table table-hover table-striped table-bordered" at-config="config">
                    ...
                    <tbody>
                        <tr role="row" dir-paginate="list in professionRow| filter:search  |filter:searchData |orderBy:orderByField:reverseSort | itemsPerPage:itemsPerPage" >
                            ...
                            <td class="fa-div" style="display: flex;">
                                <div class="fa-hover" tooltip-html-unsafe="Edit profession"  data-toggle="modal" data-target="#professionModal"><a href="javascript:void(0);" ng-click="initialModal({{ list.id}},'{{list.profession}}','{{list.status}}',{{ itemsPerPage}},{{$index}})"><i class="fa fa-pencil"></i></a></div>
                                <div class="fa-hover" tooltip-html-unsafe="Delete profession" data-toggle="modal" data-target="#professionModalD"><a href="javascript:void(0);" ng-click="initialModal({{ list.id}},'{{list.profession}}','{{list.status}}',{{ itemsPerPage}},{{$index}})"><i class="fa fa-trash-o"></i></a></div>
                            </td> 
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="modal-content">
                ...
                <form novalidate ng-submit="professionForm.$valid && doprofessionAction()" name="professionForm">
                    ...
                    <div class="modal-footer" align="center">
                        <button type="Submit" class="btn btn-sub btn-primary" ng-click="sbtBtn = true" ng-disabled="profBtn">{{action}}</button>
                    </div> 
                </form>           
            </div>
        </div>
    ...
    <!--model Delete-->
    <div class="modal fade" id="professionModalD" role="dialog" tabindex="-1">   
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" align="center">Delete Profession</h4>
                </div>
                <form novalidate ng-submit="professionForm.$valid && doprofessionDelete()" name="professionForm">
                    <input type="hidden" ng-model="csrfToken" name="csrftoken" id="csrftoken" ng-init="csrfToken = '<?php echo csrf_token(); ?>'" class="form-control">
                    ...
                    <div class="modal-footer" align="center">
                        <button type="Submit" class="btn btn-sub btn-primary" ng-click="sbtBtn = true" ng-disabled="profBtn">Confirm</button>
                        <button type="button" class="btn btn-sub btn-primary" ng-click="Cancel()" ng-disabled="profBtn">Cancel</button>
                    </div> 
                </form>           
            </div>
        </div>
