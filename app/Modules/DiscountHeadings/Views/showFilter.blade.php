                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <span class="input-icon icon-right">
                                            <input type="text" ng-model="filterData.discount_name" name="discount_name" class="form-control" >
                                        </span>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <span class="input-icon icon-right">
                                            <input type="text" ng-model="filterData.status" name="status" class="form-control">
                                        </span>
                                    </div>
