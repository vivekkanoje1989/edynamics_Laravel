...
<div class="row" ng-controller="highestEducationCtrl" ng-init="manageHighestEducation()">  
                    ...
                    <tbody>
                        <tr role="row" dir-paginate="list in educationRow | filter:search |filter:searchData | itemsPerPage:itemsPerPage|orderBy:orderByField:reverseSort">
                            ...
                            <td class="fa-div">
                                ...
                                <div class="fa-hover" tooltip-html-unsafe="Delete highest education" style="display: block;" data-toggle="modal" data-target="#highesteducModalD"><a href="javascript:void(0);" ng-click="initialModal({{ list.id}},'{{list.education}}','{{list.status}}',{{itemsPerPage}},{{$index}})"><i class="fa fa-trash-o"></i></a></div>
                            </td> 
                        </tr>
                    </tbody>
                </table>
    ...
    <!-- Modal delete -->
    <div class="modal fade" id="highesteducModalD" role="dialog" tabindex="-1">    
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" align="center">Delete Highest Education</h4>
                </div>
                <form novalidate ng-submit="highesteducForm.$valid && doHighestEducationDelete()" name="highesteducForm">
                    <input type="hidden" ng-model="csrfToken" name="csrftoken" id="csrftoken" ng-init="csrfToken = '<?php echo csrf_token(); ?>'" class="form-control">
                    ...
                    <div class="modal-footer" align="center">
                        <button type="Submit" class="btn btn-primary" ng-click="sbtBtn = true" ng-disabled="eduBtn">Confirm</button>
                        <button type="button" class="btn btn-primary" ng-click="Cancel()" ng-disabled="eduBtn">Cancel</button>
                    </div> 
                </form>           
            </div>
        </div>
