...
<form novalidate ng-submit="blogsForm.$valid && doblogscreateAction()" name="blogsForm" ng-init="manageUsers([[ !empty($blogId) ?  $blogId : '0' ]],'edit')">
                        ...
                        <input type="hidden" ng-model="blogId" name="blogId" id="blogId"  >                 
                           ...
                           <tr><td>Description *</td>
                            ...
                            <tr><td>Banner Image</td>
                                <td>
                                    <span class="input-icon icon-right">
                                        <input type="file" class="form-control" ng-model="bannerImage" name="bannerImage" >
