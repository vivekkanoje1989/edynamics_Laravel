...
<div class="row" ng-controller="manageDepartmentCtrl" ng-init="manageDepartment()">  
                    ...
                    <tbody>
                        <tr role="row" dir-paginate="list in departmentRow| filter:search |filter:searchData | itemsPerPage:itemsPerPage |orderBy:orderByField:reverseSort" >
                            ...
                            <td class="fa-div">
                                ...
                                <div class="fa-hover" tooltip-html-unsafe="Delete department" style="display: block;" data-toggle="modal" data-target="#departmentModalD"><a href="javascript:void(0);" ng-click="initialModal({{ list.id}},{{list}},{{ itemsPerPage}},{{$index}})"><i class="fa fa-trash-o"></i></a></div>
                            </td> 
                        </tr>
                    </tbody>
                </table>
    ...
    <!--model delete-->
    <div class="modal fade" id="departmentModalD" role="dialog" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">                
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" align="center">Delete Department</h4>
                </div>
                <input type="hidden" class="form-control" ng-model="id" name="id">
                <form novalidate ng-submit="departmentForm.$valid && doDepartmentDelete(departmentData)" name="departmentForm" role="form">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Department Name<span class="sp-err">*</span></label>
                            <span class="input-icon icon-right">
                    ...
                    <div class="modal-footer" align="center">
                        <button type="Submit" class="btn btn-primary" ng-click="sbtBtn = true" ng-disabled="deptBtn">Confirm</button>
                        <button type="button" class="btn btn-primary" ng-click="Cancel()" ng-disabled="deptBtn">Cancel</button>
                    </div> 
                </form>
            </div>
        </div>
