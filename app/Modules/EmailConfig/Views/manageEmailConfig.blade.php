                ...
                <form name="emailConfigForm" novalidate ng-submit="emailConfigForm.$valid && createEmail(emailData, [[ $id ]])">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-sm-4 col-xs-6">
                                <div class="form-group multi-sel-div" ng-controller="listDepartmentCtrl" ng-class="{ 'has-error' : step1 && (!emailConfigForm.department_id.$dirty && emailConfigForm.department_id.$invalid)}">
                                    ...
                                    <ui-select multiple ng-model="emailData.department_id" name="department_id" theme="select2" ng-disabled="disabled" style="width: 300px;" ng-required="true"  ng-change="checkDepartment()">
                                        ...
                                        <ui-select-choices repeat="list in lstdepartments  | filter:$select.search">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="col-sm-4 col-xs-6">
                                <input type="button"  class="btn btn-success" value="Test Mail" ng-disabled="(!emailConfigForm.email.$dirty && emailConfigForm.email.$invalid) && (!emailConfigForm.password.$dirty && emailConfigForm.password.$invalid)" ng-click="testMail(emailData, [[ $id ]])">
                                <input type="submit" id="savebtn" class="btn btn-primary" value="Save" style="display:none;">
                            </div>
