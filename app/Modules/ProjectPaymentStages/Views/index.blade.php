                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label for=""></label>
                            <span class="input-icon icon-right">
                                <a data-toggle="modal" data-target="#projectpaymentModal" ng-click="initialModal(0, '', '', '', '')" class="btn btn-primary btn-right">Add Payment Stages</a>
                ...
                <table class="table table-hover table-striped table-bordered" at-config="config">
                    <thead class="bord-bot">
                        ...
                        <tr>
                            ...
                            <th style="width: 30%">
                                <a href="javascript:void(0);" ng-click="orderByField = 'stage_name'; reverseSort = !reverseSort">Project Stages
                                    <span ng-show="orderByField == 'stage_name'">
                    ...
                    <tbody>
                        <tr role="row" dir-paginate="list in ProjectPaymentStagesRow | filter:search |filter:searchData| orderBy:orderByField:reverseSort| itemsPerPage:itemsPerPage" >
                            <td>{{itemsPerPage * (noOfRows - 1) + $index + 1}} </td>
                            <td>{{ list.stage_name}}</td>   
                            <td class="fa-div">
                                <div class="fa-hover" tooltip-html-unsafe="Edit Information" style="display: block;" data-toggle="modal" data-target="#projectpaymentModal"><a href="javascript:void(0);" ng-click="initialModal({{ list.id}},'{{ list.stage_name}}',{{list.project_type_id}},{{list.fix_stage}},{{ itemsPerPage}},{{$index}})"><i class="fa fa-pencil"></i></a></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
