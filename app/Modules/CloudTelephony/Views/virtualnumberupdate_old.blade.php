                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 bord-l8">
                                ...
                                <div class="row" ng-controller="salesSourceCtrl">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="">Sales source</label>
                                            <span class="input-icon icon-right">
                                                <select class="form-control" ng-change="onsalesSoucesChange(registrationData.source_id)" ng-model="registrationData.source_id" name="sales_source_id" id="sales_source_id" ng-disabled="registrationData.editing_status == '1'" required>
                                ...
                                <div class="row"> 
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div  class="form-group" ng-class="{ 'has-error' : step1 && (!updatevnoForm.nwh_end_time.$dirty && updatevnoForm.nwh_end_time.$invalid)}">
                                            <label for="">Select Your Resume Working From Hours <span class="sp-err">*</span></label>
                                            <span class="input-icon icon-right">
