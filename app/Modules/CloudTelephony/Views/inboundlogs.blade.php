...
<div class="row" ng-controller="cloudtelephonyController" ng-init="inboundLists([[$loggedInUserId]], 1, [[config('global.recordsPerPage')]])">
        ...
        <div class="widget flat radius-bordered">
            ...
            <div class="widget-body table-responsive">
                <div class="row">
                    <div class="col-sm-2 ">
                        <div class="form-group">
                            ...
                            <span class="input-icon icon-right">
                                <input type="text" minlength="1" maxlength="3" ng-model="itemsPerPage" ng-change="inboundLists([[$loggedInUserId]],{{pageNumber}}, itemsPerPage)" ng-model-options="{ updateOn: 'blur' }" oninput="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  class="form-control">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <span class="input-icon icon-right">
                                <button type="button" class="btn btn-primary ng-click-active" style="float: right;margin-left: 10px;" data-toggle="modal" data-target="#showFilterModal" ng-click="procName('proc_team_inboundlogs', 0)">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <span class="input-icon icon-right">
                                ...
                                <a href="javascript:void(0);" id="exportExcel" uploadfile class="btn btn-primary" ng-click="inLogexportReport(inboundList)" ng-show="btnExport">
                    ...
                    <div class="col-sm-6 col-xs-12 dataTables_paginate paging_bootstrap" id="DataTables_Table_0_paginate">
                        <div class="form-group">
                            <label for="search"></label>
                            <span class="input-icon icon-right">
                                <span ng-if="inboundLength">&nbsp; &nbsp; &nbsp; Showing {{inboundList.length}} records out of  {{inboundLength}} records&nbsp;</span>
                                <dir-pagination-controls class="pull-right pagination" on-page-change="pageChanged(newPageNumber,'inboundLists', [[$loggedInUserId]])" template-url="/dirPagination"></dir-pagination-controls>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-hover table-striped table-bordered" at-config="config">
                    ...
                    <tbody>
                        <tr dir-paginate="inbound in inboundList | filter:search | itemsPerPage: itemsPerPage" total-items="{{ inboundLength}}">
                            <td>{{ itemsPerPage * (pageNumber - 1) + $index + 1}}</td>  
                            <td>{{ inbound.call_date + ' @ ' + inbound.call_time}}
                        ...
                        <tr>
                            <td colspan="8" ng-if="!inboundLength" align="center">Record Not Found</td>   
                        </tr>
                    </tbody>
                </table><br>
                <div class="DTTTFooter" ng-if="!inboundLength">
                    <div class="col-sm-6">
