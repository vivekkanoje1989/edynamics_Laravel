    ...
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            <div class="widget-header ">
                ...
                <a title="Create blog" class="btn btn-primary" href="#/[[config('global.getUrl')]]/manage-blog/create" >Create blogs</a>
                ...
                <table class="table table-hover table-striped table-bordered" at-config="config">
                    ...
                    <tbody>
                        ...
                        <tr role="row" ng-repeat="item in blogsRow| filter:search  | orderBy:orderByField:reverseSort">
                            ...
                            <td class="fa-div">
                                <div class="fa-hover" tooltip-html-unsafe="Edit contact" style="display: block;" data-toggle="modal"><a href="#/[[config('global.getUrl')]]/manage-blog/update/{{ item.blog_id }}"><i class="fa fa-pencil"></i></a></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
