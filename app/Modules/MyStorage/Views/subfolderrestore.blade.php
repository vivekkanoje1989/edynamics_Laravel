                    ...
                    <div class="col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <span class="input-icon icon-right">
                                <button confirmed-click="restoreFolder('[[ $folderId ]]');" ng-confirm-click="Are you sure restore folder?" class="btn btn-primary btn-right">Restore Folder</button>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" ng-if="folderImages != ''">
                    <div class="col-md-2" ng-repeat="imgs in folderImages track by $index | unique:'imgs' " style="margin:15px 0 25px 0;">
                        <div class="img-wrap"> 
                         ...
                         <a href="https://s3.ap-south-1.amazonaws.com/bmsbuilderv2/{{imgs.file_url}}" target="_blank">    
                             <img ng-src="https://s3.ap-south-1.amazonaws.com/bmsbuilderv2/{{imgs.file_url}}" height="100px;" width="100px;" ></a>
                        </div>
                    </div>
                </div>
