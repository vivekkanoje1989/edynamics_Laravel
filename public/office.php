...
if (empty($_SESSION['client_info']) || empty($_SESSION['aws_bucket_id'])) {
    ...
    if (!$connetion) {
        ...
        $_SESSION['client_info'] = $result_row;
        $_SESSION['client_id'] = $result_row['master_client_id'];
        $_SESSION['brand_id'] = $result_row['brand_id'];
        ...
        $_SESSION['aws_bucket_id'] = $system_row['aws_bucket_id'];
    }
} else {
    $GLOBALS['client_info'] = json_encode($_SESSION['client_info']);
    $GLOBALS['client_id'] = $_SESSION['client_id'];
    $GLOBALS['brand_id'] = $_SESSION['brand_id'];
    $GLOBALS['aws_bucket_id'] = $_SESSION['aws_bucket_id'];
}*/
/*
|--------------------------------------------------------------------------
