<div class="chatbar-contacts">
    ...
    <ul class="contacts-list">
        ...
        <li class="contact">
            <div class="contact-avatar">
                <img src="/backend/assets/img/avatars/Nicolai-Larson.jpg" />
            </div>
            <div class="contact-info">
        ...
        <li class="contact">
            <div class="contact-avatar">
                <img src="/backend/assets/img/avatars/John-Smith.jpg" />
            </div>
            <div class="contact-info">
        ...
        <li class="contact">
            <div class="contact-avatar">
                <img src="/backend/assets/img/avatars/Osvaldus-Valutis.jpg" />
            </div>
            <div class="contact-info">
        ...
        <li class="contact">
            <div class="contact-avatar">
                <img src="/backend/assets/img/avatars/Javi-Jimenez.jpg" />
            </div>
            <div class="contact-info">
        ...
        <li class="contact">
            <div class="contact-avatar">
                <img src="/backend/assets/img/avatars/Stephanie-Walter.jpg" />
            </div>
            <div class="contact-info">
        ...
        <li class="contact">
            <div class="contact-avatar">
                <img src="/backend/assets/img/avatars/Sergey-Azovskiy.jpg" />
            </div>
            <div class="contact-info">
        ...
        <li class="contact">
            <div class="contact-avatar">
                <img src="/backend/assets/img/avatars/Lee-Munroe.jpg" />
            </div>
            <div class="contact-info">
