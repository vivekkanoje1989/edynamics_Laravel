            ...
            <div class=" partner-form " ng->
                <form name="requestDemo" novalidate ng-submit="requestDemo.$valid && requestDemos(request)" >
                    ...
                    <div class="md-form"> <i class="fa fa-mobile-phone prefix"></i>
                        <input type="number" name="mobile_number" ng-model="request.mobile_number" required ng-minlength="10" ng-maxlength="10" maxlength="10" class="form-control validate">
                        ...
                        <div ng-show="sbtBtn1" ng-messages="requestDemo.mobile_number.$error">
                            ...
                            <span ng-show="requestDemo.mobile_number.$error.minlength" ng-message="minlength" class="sp-error">Mobile no. should be 10 digits</span>
                            <span ng-show="requestDemo.mobile_number.$error.maxlength" ng-message="maxlength" class="sp-error">Mobile no. should be 10 digits</span>
                        </div>
                    </div>
