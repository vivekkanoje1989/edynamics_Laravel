...
<main class="main-content"  >
    ...
    <div class="container" ng-init="getNews();">

        <header class="heading page-heading">
            <h1>News</h1>
        </header>
                        <div class="row" ng-repeat="news in news track by $index" style="padding: 5px 5px 5px 5px; margin-top: 30px; border: 1px solid black;" >
