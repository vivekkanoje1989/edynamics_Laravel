...
@section('content')
<body class="body-bg" ng-init="getNews();">
    <div >
        <div class="container event-div"><br>
            ...
            <div class="row" ng-repeat="news in news track by $index" style="padding: 5px 5px 5px 5px; border: 1px solid black;" >
                            ...
                            <div class="col-md-8 col-xs-8">
                                ...
                                <a href="[[ URL::to('/') ]]/[[config('global.getWebsiteUrl')]]/news-details/{{news.id}}"><button class="btn btn-theme ripple-effect btn-theme-light btn-more-posts">Show More</button></a>
                            </div> 
                        </div>
        </div>
    </div>
